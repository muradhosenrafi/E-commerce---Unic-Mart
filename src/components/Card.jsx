...
<div className={`w-270px group ${className}`}>
 <Flex className="relative w-full h-250px overflow-hidden bg-card rounded-4px justify-center items-center">
   ...
   <p className="absolute top-12px left-12px bg-[#DB4444] py-2 px-12px font-poping text-xs font-normal rounded-4px text-secondary">{rating}</p>
 ...
 <p className="text-base py-8px text-[#DB4444] font-poping font-medium">{price}<span className=" font-popingtext-base text-[#00000080] font-medium"><del className="text-[#00000080]">{disprice}</del></span></p>
